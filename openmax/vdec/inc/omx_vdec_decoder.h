...
static inline OMX_ERRORTYPE OmxVdecoderGetExtPara(OmxDecoder* d,
                              AW_VIDEO_EXTENSIONS_INDEXTYPE i, OMX_PTR p)
{
    return d->ops->getExtPara(d, i, p);
}

static inline OMX_ERRORTYPE OmxVdecoderSetExtPara(OmxDecoder* d,
                              AW_VIDEO_EXTENSIONS_INDEXTYPE i, OMX_PTR p)
{
    return d->ops->setExtPara(d, i, p);
}

static inline OMX_ERRORTYPE OmxVdecoderGetExtConfig(OmxDecoder* d,
                              AW_VIDEO_EXTENSIONS_INDEXTYPE i, OMX_PTR p)
{
    return d->ops->getExtConfig(d, i, p);
}

static inline OMX_ERRORTYPE OmxVdecoderSetExtConfig(OmxDecoder* d,
                              AW_VIDEO_EXTENSIONS_INDEXTYPE i, OMX_PTR p)
{
